...
export default function EditProfile() {
  ...
  //for updating users profile image and host image
  ...
  // for update user profile information
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit(handleUpdateProfile)} className="mb-5">
        ...
        <input className="w-40 mt-4 ml-4 text-white bg-blue-600 hover:text-black btn rounded-3xl" value="Update Profile" type="submit" />
